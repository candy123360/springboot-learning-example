...
public class CityHandlerUnitTest {
    ...
    @Test
    public void deleteCityReturnsPublisherThatSubscribesToRepositoryDelete() throws Exception {
    ...
    private void setRedisTemplate(CityHandler cityHandler) throws Exception {
        Field redisTemplate = CityHandler.class.getDeclaredField("redisTemplate");
        redisTemplate.setAccessible(true);
        redisTemplate.set(cityHandler, new NoOpRedisTemplate());
    }
    ...
    private static class NoOpRedisTemplate extends RedisTemplate {
